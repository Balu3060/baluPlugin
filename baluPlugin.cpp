...
float baluPlugin::GetMMRNeededForNextRank(int playlist, float currentMMR) {
    ...
    if (playlist == 10) {
        thresholds = {
            114, 128, 142, 147, 159, 178, 197, 215, 219, 238, 257, 260, 279, 
            298, 317, 320, 339, 358, 377, 380, 399, 418, 437, 440, 459, 478, 
            497, 500, 519, 538, 557, 560, 579, 598, 617, 620, 639, 658, 677, 
            699, 718, 737, 759, 778, 797, 815, 819, 838, 857, 860, 879, 898, 
            917, 935, 939, 958, 976, 995, 999, 1018, 1037, 1053, 1059, 1078, 
            1097, 1108, 1119, 1138, 1157, 1164, 1179, 1198, 1217, 1221, 1240, 
            1258, 1277, 1281, 1299, 1318, 1336, 1345
        };
    } else if (playlist == 11) {
        thresholds = {
        ...
        thresholds = {
            119, 138, 157, 166, 179, 198, 217, 234, 239, 258, 277, 280, 299, 
            318, 337, 340, 359, 378, 397, 400, 419, 438, 457, 460, 479, 498, 
            517, 535, 539, 558, 577, 580, 599, 618, 637, 655, 659, 678, 697, 
            715, 719, 738, 757, 766, 779, 798, 817, 835, 844, 868, 892, 914, 
            924, 948, 972, 995, 1004, 1028, 1052, 1075, 1094, 1128, 1162, 1195, 
            1214, 1248, 1282, 1315, 1334, 1368, 1402, 1435, 1460, 1498, 1537, 
            1575, 1600, 1638, 1677, 1705, 1744, 1788, 1832, 1865
        };
    } else {
        return -1.0f;
    }
